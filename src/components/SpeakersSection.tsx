          ...
          {speakers.map((speaker, index) => (
            ...
            >
              <div className="grid sm:grid-cols-[160px_1fr] items-start">
                <div className="h-40 sm:h-44 bg-white">
                  <img
                    src={speaker.image}
                    alt={speaker.name}
                    className={`w-full h-full object-center ${speaker.imageClass}`}
                    loading="lazy"
                  />
                </div>
                <div className="p-5">
                  ...
                  <p className="text-accent text-sm font-medium mt-1">{speaker.role}</p>
